...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany((Articke::class['id => article_id']));
    }
    ...
    public function updateAccount($id)
    {
        ...
        $user = $this->find()->where('id = :id', [':id' => $id])->one();
        $this->oldImage = $user->image;
        if ($this->imageFile !== null) {
            $user->image = $this->image;
            unlink('img/user/' . $this->oldImage);
        } else {
            $user->image = $this->oldImage;   
        }
    ...
    public function upload()
    {
        ...
        $this->imageFile->saveAs('img/user/' . $fullImageName);
